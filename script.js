...
function getAgentResponse(user_input){
    ...
    let url = 'https://flask-sandy-xi.vercel.app/get_response';
...
function getSDGEvaluation(transcript){
    let xhr = new XMLHttpRequest();
    let url = 'https://flask-sandy-xi.vercel.app/evaluate_by_sdg';
    xhr.open("POST", url, true);
...
function getInvestmentEvaluation(transcript){
    let xhr = new XMLHttpRequest();
    let url = 'https://flask-sandy-xi.vercel.app/evaluate_by_investment';
    xhr.open("POST", url, true);
